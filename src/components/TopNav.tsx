...
import { Home, Settings, Gavel, Monitor, Users, Trophy, Globe, ShieldAlert, Radio, MapPin, GitBranch, Activity, BarChart3, Menu, ChevronDown, Swords, LayoutDashboard, ListChecks, ClipboardList, Settings2, Save, Palette } from 'lucide-react';
