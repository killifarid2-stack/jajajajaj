    ...
    <div ref={boxRef} className="relative">
      <div className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg bg-secondary border border-border">
        ...
        <input
          ...
          placeholder={placeholder || (lang === 'ar' ? 'ابحث عن بطولة موجودة...' : lang === 'fr' ? 'Rechercher un tournoi existant…' : 'Search an existing tournament...')}
          ...
          <div className="max-h-56 overflow-y-auto">
            ...
            {!loading && results.length === 0 && (
              <div className="px-3 py-2 text-xs text-muted-foreground">
                {lang === 'ar' ? 'ماكاينش بطولة بهاد الاسم — كتبقى تقدر تكتب اسم جديد فوق وتحفظ عادي.' : lang === 'fr' ? 'Aucun tournoi correspondant — vous pouvez saisir un nouveau nom et enregistrer.' : 'No matching tournament — typing a new name above and saving will still work as before.'}
              </div>
            )}
