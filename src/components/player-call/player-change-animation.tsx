...
export function PlayerChangeAnimation({
  ...
  return (
    <div dir="ltr" data-wab-layer-root="player-change" className={`wab-broadcast-layer fixed inset-0 z-[95] flex items-center justify-center bg-black/95 ${reducedMotion ? 'pc-reduced' : ''}`} role="dialog" aria-live="polite" aria-label={headline}>
