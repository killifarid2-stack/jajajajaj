    ...
    <div className="flex flex-1 min-w-0 rounded-lg overflow-hidden border border-white/10 bg-white/[0.02] shadow-[0_6px_24px_rgba(0,0,0,.18)]">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between bg-[#3a3a3a] px-3 py-1.5 gap-2">
          ...
          <table className="shrink-0"><tbody><tr className="text-[9px] font-black text-white/55"><td className="w-10 text-center">R1</td><td className="w-10 text-center">R2</td><td className="w-14 text-center text-[hsl(var(--gold))]">R3</td><td className="w-10 text-center">GR</td><td className="w-16 text-center text-[hsl(var(--gold))]">TOTAL</td><td className="w-10 text-center">GJ</td></tr></tbody></table>
        </div>
        {(['chung', 'hong'] as const).map(side => {
          ...
          return <div key={side} className={`flex items-center justify-between px-3 py-2 ${blue ? 'bg-[#2467d6]/80' : 'bg-[#d33a45]/80'}`}>
            ...
            <table className="shrink-0"><tbody><tr>
              ...
              <td className="w-14 text-center text-xl font-black text-white">{r3[blue ? 'c' : 'h'] ?? ''}</td>
              <Cell value={blue ? gr.c : gr.h} /><td className="w-16 text-center text-xl font-black text-[hsl(var(--gold))]">{total ?? 0}</td><Cell value={gj} />
            </tr></tbody></table>
          </div>;
        })}
      </div>
